...
const contracts = [
  ...
  ['Studio preview omits its own promotional entry points', onlineStudioPage.includes('?studioPreview=1') && profileRenderer.includes('data-studio-only-section') && previewBridge.includes("dataset.studioPreview !== 'true'") && css.includes('html[data-studio-preview="true"] [data-studio-link-card]') && css.includes('html[data-studio-preview="true"] .footer-studio-link')],
