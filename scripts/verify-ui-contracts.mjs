...
const contracts = [
  ...
  ['ZIP imports validate before committing media and draft state', onlineStudioApp.includes('const nextState = parseImportedDraft') && onlineStudioApp.indexOf('bytes.length > 5 * 1024 * 1024') < onlineStudioApp.indexOf('await writeStoredMediaBatch(media)') && onlineStudioApp.indexOf('await writeStoredMediaBatch(media)') < onlineStudioApp.indexOf('state = nextState')],
