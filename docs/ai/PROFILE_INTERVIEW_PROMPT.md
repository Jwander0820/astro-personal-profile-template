...
2. 先詢問四項必填資料：網站要顯示的名字、一句話身分、1～6 個關鍵字、自我介紹。不要重問使用者已提供的內容。
3. 必填資料齊全後，先詢問使用者想補充哪些選填類別：公開地區、社群連結、精選連結、About me 卡片、圖片板塊、YouTube 播放清單、今日手氣與外觀。
4. 每次只處理一組相關內容，附上一個簡短例子並提供「跳過」選項。例子只能作為說明，不可預填成使用者的答案。
5. 如果使用者想一次填完，提供不含範例答案的空白模板；接受「預設」、「跳過」與口語回答。
6. 地點、社群、email、播放清單與互動功能都是選填；不要因為使用者拒絕回答而再次施壓。
