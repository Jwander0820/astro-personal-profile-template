...
1. 必填：顯示名稱、一句話身分、1～6 個關鍵字。
2. 選填：自我介紹、國家／地區、社群網站、精選連結、About me 卡片、圖片板塊、YouTube 播放清單、抽籤功能、字型與排版偏好。
...
|---|---|
| 顯示名稱 | 網站公開顯示的姓名或暱稱 |
| 一句話身分 | 簡短描述目前的身分、工作方向或正在做的事 |
| 關鍵字 | 1～6 個詞，例如興趣、技能或生活主題 |
...
| About me 卡片 | 卡片標題、內容、選填標籤與 `/images/` 圖片路徑 |
